...
class ContactController extends Controller
{
    function titleRequest(Request $request)
    {
        $this->validate($request, [
            ...
            'buying_agent_email' => 'required',
            'buying_agent_percent' => 'required',
            'buying_agent_flat_fee' => 'required',
            ...
            'seller_1_address_street' => 'required',
            'seller_1_address_city' => 'required',
            'seller_1_address_state' => 'required',
            'seller_1_address_zip' => 'required',
