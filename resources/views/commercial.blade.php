...
@section('content')
    <div class="row col-12 no-gutters">
        ...
        <div class="col-9">
            ...
            <p>Our staff draws from a wide range of experience in the commercial real estate industry, allowing you to complete even the most complicated settlements with confidence. We begin with a thorough title search and examination, to identify and address any concerns prior to closing. Our practice of pre-titling all our commercial title work insures you come to the settlement table with complete confidence.</p>

            <p>Commercial title services include:</p>
